...
@Entity(name = "EmlpoyeeProfileOrgProvidedTrainings")
@Table(schema = "\"generated_app\"", name = "\"EmlpoyeeProfileOrgProvidedTrainings\"")
@Data
public class EmlpoyeeProfileOrgProvidedTrainings{
