...
@Table(name = "\"Trainings\"", schema =  "\"generated_app\"")
@Data
...
public class Trainings {
  ...
  @Column(name = "\"MandatoryTrainings\"", nullable = true )
  private String mandatoryTrainings;
  
	  
  @Column(name = "\"OrgCompleteBy\"")
  @Temporal(value = TemporalType.TIMESTAMP)
  private Date orgCompleteBy;  
  
	  
  @Column(name = "\"MandatoryTechnicaltrainings\"", nullable = true )
  private String mandatoryTechnicaltrainings;
  
	  
  @Column(name = "\"TechCompleteBy\"")
  @Temporal(value = TemporalType.TIMESTAMP)
  private Date techCompleteBy;  
  
	  
  @Column(name = "\"WorkshopAttended\"", nullable = true )
  private String workshopAttended;
  ...
  + "OrgCompleteBy= " + orgCompleteBy  + ", " 
  + "MandatoryTechnicaltrainings= " + mandatoryTechnicaltrainings  + ", " 
  + "TechCompleteBy= " + techCompleteBy  + ", " 
